...
class Agent:
    def __init__(self, state_space, action_space, max_action, alpha=0.0003, beta=0.0003, gamma=0.99, max_size=1000000,
                 tau=0.005, batch_size=256, reward_scale=2):
        self.gamma = gamma
        self.tau = tau
...
def robot_epoch(robot, episodes=20, steps=20):
    agent = Agent(state_space=4, action_space=2, max_action=0.2)
